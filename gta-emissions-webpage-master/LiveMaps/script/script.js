...
function initializeMap() {                                         
  var map = L.map('map').setView([43.6603547, -79.3982189], 13);    //Center the map on the physics building by default
//  var mapMarkers = [];
...
// Get the colour of each dot by scaling based on the max and min values
